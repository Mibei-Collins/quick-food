...
$lang['header'] = [
	...
	"subtitle"        => "The food is always delivered quickly and still hot, we havea variety of food options.",
	"btn"             => "Order now",
	...
	"today"          => "Today 08:00 am - 10:00 pm",
	"phone"          => "(+254) 797865 51 55",
];

# + Home
$lang['home'] = [
	"nearby"           => "Explore Your Nearby Restaurants",
	"nearby_desc"      => "FREE DELIVERIES we've got you covered. Thank you for choosing Quick Food and we can't wait to serve you!",
	"best"           => "Explore Our Best Menu",
	"best_desc"      => "Welcome to Quick Food! We're thrilled to have you as a part of our community of food lovers Our mission is to make mealtime simple, delicious and hassle-free With our quick and easy ordering process and reliable delivery, we're here to make sure you have more time to enjoy the things you love Whether you're in the mood for your favorite comfort food or trying something new we've got you covered. Thank you for choosing Quick Food and we can't wait to serve you!.",
	"addtocart"      => "Add to cart",
	"more"           => "Load more",
	"how"            => "How it works",
	"how_desc"       => "Browse the Menu online.",
	"how1"           => "Pick Meals",
	"how1_desc"      => "Once you have made your selection place your order and provide their delivery address and payment information.",
	"how2"           => "Choose Payment",
	"how2_desc"      => "you can pay via Card or PayPal.",
	"how3"           => "Fast Deliveries",
	"how3_desc"      => "The food is always delivered quickly and still hot, I highly recommend this service to anyone who loves delicious, hot food and wants to make their life easier.",
	"customers"      => "What Our Customers Saying",
	"customers_desc" => "I absolutely love the hot food delivery service! It's become a game-changer in my daily routine The
food is always delivered quickly and still hot, which is so important to me.",
