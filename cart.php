			...
			<div class="pt-cart-body">
	          ...
	          <h2><?=$lang['cart']['billing']?></h2>
	            ...
	            <label class="label">
	              ...
	              <input name="name" value="<?=us_firstname?> <?=us_lastname?>" class="field" placeholder="Edwin Macharia" required>
	            </label>
	            <label class="label">
	              <span><?=$lang['cart']['email']?></span>
	              <input name="email" value="<?=us_email?>" type="email" class="field" placeholder="edwinexample22@gmail.com" required>
	            </label>
	            <label class="label">
	              <span><?=$lang['cart']['phone']?></span>
	              <input name="phone" value="<?=us_phone?>" type="text" class="field phone" placeholder="+254 000-000-000"required>
	            </label>
	            <label class="label">
	              <span><?=$lang['cart']['address']?></span>
	              <input name="address" value="<?=us_address?>" class="field" placeholder="251 MOI Avenue Street 550"required>
	            </label>
	            <label class="label">
	              <span><?=$lang['cart']['city']?></span>
	              <input name="city" value="<?=us_city?>" class="field" placeholder="Nairobi"required>
	            </label>
	            ...
	            <label class="zip label">
	              ...
	              <input name="postal_code" class="field" placeholder="101010"required>
	            </label>
