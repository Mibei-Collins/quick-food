<div class="pt-footer">
	<div class="container">
		<div class="row">
			<div class="col-3">
				<div class="pt-logo">
					<a href="#"><i class="fas fa-hamburger"></i> Quick Food</a>
				</div>
				<div class="pt-social">
          ...
          ?>
			...
			<div class="col-3">
				<div class="pt-copy">
					<h3>&nbsp;</h3>
					<div class="pt-lang">
						<a hrfe="#" rel="en"><i class="flag-icon flag-icon-squared flag-icon-ke"></i></a>
						<a hrfe="#" rel="fr"><i class="flag-icon flag-icon-squared flag-icon-ug"></i></a>
						<a hrfe="#" rel="es"><i class="flag-icon flag-icon-squared flag-icon-tz"></i></a>
						<a hrfe="#" rel="tr"><i class="flag-icon flag-icon-squared flag-icon-sa"></i></a>
						<a hrfe="#" rel="ar"><i class="flag-icon flag-icon-squared flag-icon-us"></i></a>
					</div>
					Copyright &copy; 2023 <a href="<?=path?>">Quick Food</a>. All Rights Reserved.
				</div>
			</div>
		</div>
	</div>
